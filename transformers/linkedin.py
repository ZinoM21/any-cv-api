            ...
            positions.append(
                {
                    ...
                    # "workSetting": (
                    #     "Remote"
                    #     if "Remote" in str(pos.get("metadata", ""))
                    #     else (
                    #         "On-site"
                    #         if "On-site" in str(pos.get("metadata", ""))
                    #         else None
                    #     )
                    # ),
                }
...
def format_education(edu: dict) -> dict:
...
def format_volunteering(vol: dict) -> dict:
...
def transform_linkedin_data(data: dict) -> dict:
